...
$prof = 'Manager';
$phone = '89637107818';
$email = 'andrey@simashev';

$newarray = [95,85,77,65];
?>
    ...
    <div class="w3-third">
      ...
      <div class="w3-white w3-text-grey w3-card-4">
        ...
        <div class="w3-container">
          <p><i class="fa fa-briefcase fa-fw w3-margin-right w3-large w3-text-teal"></i><?=$city;?></p>
          ...
          <div class="w3-light-grey w3-round-xlarge w3-small">
            <div class="w3-container w3-center w3-round-xlarge w3-teal" style="width:<?=$newarray [0];?>%"><?=$newarray [0];?></div>
          </div>
          <p>Photography</p>
          <div class="w3-light-grey w3-round-xlarge w3-small">
            <div class="w3-container w3-center w3-round-xlarge w3-teal" style="width:<?=$newarray [1];?>%">
              <div class="w3-center w3-text-white"><?=$newarray [1];?></div>
            </div>
          </div>
          <p>Illustrator</p>
          <div class="w3-light-grey w3-round-xlarge w3-small">
            <div class="w3-container w3-center w3-round-xlarge w3-teal" style="width:<?=$newarray [2];?>%"><?=$newarray [2];?></div>
          </div>
          <p>Media</p>
          <div class="w3-light-grey w3-round-xlarge w3-small">
            <div class="w3-container w3-center w3-round-xlarge w3-teal" style="width:<?=$newarray [3];?>%"><?=$newarray [3];?></div>
          </div>
          <br>
...
<?php echo $job['job_desc'][2]; ?>
  ...
  <?php
    ...
    $dbhost = 'localhost';
    $dbname = 'cs27632_v2323232';
    $dbuser = 'cs27632_v2323232';
    $dbpass = 'eZkMGX8n';
